...
type EnumeratedPartialNarrowed<T, S> = T extends unknown ? Simplify<IfBoundedRecord<T, ExactProps<T, S> & PartialProps<T, S>, Record<EnumerableStringKeyOf<T>, Extract<EnumerableStringKeyedValueOf<T>, S>>>> : never;
type ExactProps<T, S> = {
